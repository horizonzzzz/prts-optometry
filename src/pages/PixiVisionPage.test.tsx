...
function createScene(): PixiVisionScene {
  return {
    ...
    moveBattleBy: vi.fn(),
    moveDriftBy: vi.fn(),
    primeBattleAudio: vi.fn(),
    reset: vi.fn(),
    showEndingControls: vi.fn(),
    startBattle: vi.fn(),
    startEpilogue: vi.fn((): DialogueSnapshot => ({ complete: false, lineCount: 1, lineIndex: 0, speaker: 'priestess', speakerName: '普瑞赛斯', text: '' })),
    setMuted: vi.fn(),
